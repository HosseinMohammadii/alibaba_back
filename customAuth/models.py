...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    def is_hotel_owner(self):
        if self.user_type == UserTypeChoices.hotel_owner:
            return True
        return False

    @property
    def is_regular(self):
        if self.user_type == UserTypeChoices.regular:
            return True
        return False

    def set_user_type_hotel_owner(self):
        self.user_type = UserTypeChoices.hotel_owner
        self.save()

    def set_user_type_regular(self):
        self.user_type = UserTypeChoices.regular
        self.save()
